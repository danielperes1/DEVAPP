...
set arqvscode=VSCode-win32-x64-1.132.0.zip
...
set downmaven=https://dlcdn.apache.org/maven/maven-3/3.9.16/binaries/apache-maven-3.9.16-bin.zip
set arqmaven=apache-maven-3.9.16-bin.zip
set nomemaven=apache-maven-3.9.16
